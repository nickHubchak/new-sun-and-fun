...
$query="INSERT INTO Placed_Order (order_id, customer_id, product_id, product_quantity, product_image, orderdatetime, Fullfilled) VALUES
($order_id, $customer_id, $product_id, $productquantity, '$productimage','$orderdate', 'No')";

if($result=mysqli_query($con, $query))
{
    $ordersuccess=true;
    $_SESSION['order-complete']=true;
...
<body>
  ...
  {
    echo "<h4>Hi $username, your Order was Successfully placed.</h4>";
    echo"<h4>On $orderdate </h4>";
    echo "<h4>Your order invoice number is: ($order_id)</h4>";
    echo "<h4>Your order will be ready for pickup in approximently 25 min.</h4>";
    echo "<h4>When you come in, please tell the clerk your order number and name and they will get your order for you.</h4>";
    echo "<h4>Thank you for shopping at SunNFun</h4>";
    echo "<a href='index.php'><h4>Click here to return to home page</h4></a>";
  }
  else
  {
      echo "Error Placing order please retry.";
  }
