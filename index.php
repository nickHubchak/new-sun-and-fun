...
<body onload="checkDate()">
  ...
  <nav id="Nav01">
    <div>
      ...
      <span>
        <a class="nav-link" href="customer-login.html">SIGN IN</a>
      </span>
      <span>
        <a class="nav-link" href="contact-vendors.html">CONTACT US</a>
      </span>
      <span>
        <a class="nav-link" href="shopping-cart.html">VIEW CART</a>
      </span>
    </div>
  </nav>
  <!-- Top Navigation -->
  ...
  <div class="container-fluid p-0">
    <div class="side-slider">
      <div class="slider-one">
        ...
        <div>
          <img src="media\Beach Accesories.png" class="img-fluid" alt="Banner 4">
        </div>
      </div>
  ...
  <header>
    <center>
      <p>
        Sun N Fun overlooks the 12th street beach in Ocean City, NJ.<br />
        Custom-made benches, flip flop boxes, chairs, umbrellas, skim boards, <br />
        boogie boards, toys, books, bathing suits, <br />
        flip flops, sun glasses, sunscreen, coastal decor, and so much more.<br />
      </p>
    </center>
  </header>
  <!-- Header --->
  ...
  <nav id="Nav02">
    <div id="Nav02_Menu">
      <ul id="Nav02_Menu_Flex">
        <li>
          <a class="nav-link" href="online-shop.html">ONLINE</a>
        </li>
        <li>
          <a class="nav-link" href="in-store-gallery.html">IN-STORE</a>
        </li>
        <li>
  ...
  <main>
    ...
    <center>
      ...
      <blockquote class="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/CHmOYfhJx5g/?utm_source=ig_embed&amp;utm_campaign=loading" data-instgrm-version="13"
        style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:300px; min-width:200px; padding:0; width:50%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
        <div style="padding:16px;"> <a href="https://www.instagram.com/p/CHmOYfhJx5g/?utm_source=ig_embed&amp;utm_campaign=loading" style=" background:#FFFFFF; line-height:0; padding:0 0; text-align:center; text-decoration:none;
      width:100%;" target="_blank">
          ...
          <p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a
              href="https://www.instagram.com/p/CHmOYfhJx5g/?utm_source=ig_embed&amp;utm_campaign=loading"
              style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank">A post shared by Sun N Fun Ocean City (@sunnfunoceancity)</a></p>
        </div>
      </blockquote>
      <script async src="//www.instagram.com/embed.js"></script>
      <br />
      <iframe src="https://www.facebook.com/plugins/video.php?height=317&href=https%3A%2F%2Fwww.facebook.com%2FSunNfunOceanCity%2Fvideos%2F354941112607292%2F&show_text=true&width=560" width="560" height="432" style="border:none;overflow:hidden"
    ...
    <div class="container-fluid">
      <div class="slider-brand">
        <h3 class="text-center"><b>OUR CUSTOMERS:</b></h3>
        <br />
        <div class="slider-five px-5">
          <div>
            <img src="media\116764246_10222927514041039_754006768752273849_n.jpg" alt="Brand 1" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\123543262_10217996096115523_4885886980119544228_o.jpg" alt="Brand 2" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\micheal walsh.jpg" alt="Brand 3" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\71700286_10215684632892991_8943111011175497728_n.jpg" alt="Brand 4" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\68596137_2354069827979354_685702236159868928_n.jpg" alt="Brand 2" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\12004114_868417666568992_667749546724646882_n.jpg" alt="Brand 1" class="img-fluid" style="width:150px">
          </div>
          <div>
            <img src="media\14291808_704289064173_7566163803550967262_n.jpg" alt="Brand 3" class="img-fluid" style="width:150px">
          </div>
        </div>
      </div>
    </div>
